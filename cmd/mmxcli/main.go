...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "mmxcli",
		Short: "Command line interface for interacting with mmxd",
	}

	// Add --chain-id to persistent flags and mark it required
	rootCmd.PersistentFlags().String(client.FlagChainID, "", "Chain ID of mmx node")
	...
	// Add flags and prefix all env exposed with the cli
	executor := cli.PrepareMainCmd(rootCmd, "MMX", app.DefaultCLIHome)
